...
form_class = uic.loadUiType("123.ui")[0]
...
#   ----------------------------↓↓↓버튼↓↓↓-----------------------------------
        ...
        # 차트버튼
        self.pushButton_6.clicked.connect(self.npTest)
        self.pushButton_5.clicked.connect(self.npTest2)
...
#   ----------------------------↓↓↓함수들↓↓↓-----------------------------------
    ...
    def npTest(self):
        ...
        ax.set_title("test111111111111111")
        ax.legend()
        self.canvas.draw()
